...
*** BASIC INFO;
%let variable=total_der_fica_2010; /* name of sas variable on input file to be imputed */
%let level=4; /* will help determine order of imputation */
%let ever_out_of_universe=1; /* =1 if &variable. is ever out of universe, =0 otherwise */
%let universe_determinants=pos_der_fica_2010; /* list of variables used to determine when &variable. is in universe */
