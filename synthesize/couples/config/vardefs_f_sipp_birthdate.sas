...
*** BASIC INFO;
%let variable=f_sipp_birthdate; /* name of sas variable on input file to be imputed */
...
f_time_arrive_usa f_total_der_fica_2009 f_total_der_fica_2010
