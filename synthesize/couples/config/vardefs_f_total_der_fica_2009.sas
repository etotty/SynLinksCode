...
*** BASIC INFO;
%let variable=f_total_der_fica_2009; /* name of sas variable on input file to be imputed */
...
%let universe_determinants=f_pos_der_fica_2009; /* list of variables used to determine when &variable. is in universe */
...
f_sipp_birthdate f_time_arrive_usa f_total_der_fica_2010
