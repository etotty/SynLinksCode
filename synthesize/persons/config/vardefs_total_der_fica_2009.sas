...
*** BASIC INFO;
%let variable=total_der_fica_2009; /* name of sas variable on input file to be imputed */
...
%let universe_determinants=pos_der_fica_2009; /* list of variables used to determine when &variable. is in universe */
