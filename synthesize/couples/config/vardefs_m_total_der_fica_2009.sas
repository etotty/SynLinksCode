...
*** BASIC INFO;
%let variable=m_total_der_fica_2009; /* name of sas variable on input file to be imputed */
...
%let universe_determinants=m_pos_der_fica_2009; /* list of variables used to determine when &variable. is in universe */
...
m_sipp_birthdate m_time_arrive_usa m_total_der_fica_2010
;
