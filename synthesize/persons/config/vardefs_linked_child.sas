...
*** BASIC INFO;
%let variable=linked_child; /* name of sas variable on input file to be imputed */
...
%let universe_determinants=male; /* list of variables used to determine when &variable. is in universe */
...
%let stratifiers1=male linked_couple hhh_flag;
%let stratifiers2=male linked_couple;
%let stratifiers3=male;
/*******
