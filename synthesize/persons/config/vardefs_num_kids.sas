...
*** BASIC INFO;
%let variable=num_kids; /* name of sas variable on input file to be imputed */
%let level=5; /* will help determine order of imputation */
%let ever_out_of_universe=1; /* =1 if &variable. is ever out of universe, =0 otherwise */
%let universe_determinants=linked_mom; /* list of variables used to determine when &variable. is in universe */
...
%let stratifiers1=male linked_couple hhh_flag educ_5cat;
%let stratifiers2=male linked_couple educ_5cat;
%let stratifiers3=male linked_couple;
%let stratifiers4=male;
/*******
...
sipp_birthdate time_arrive_usa total_der_fica_2009 total_der_fica_2010
;
