...
*** BASIC INFO;
%let variable=linked_couple; /* name of sas variable on input file to be imputed */
...
%let universe_determinants=linked_child; /* list of variables used to determine when &variable. is in universe */
