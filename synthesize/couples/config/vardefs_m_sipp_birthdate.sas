...
*** BASIC INFO;
%let variable=m_sipp_birthdate; /* name of sas variable on input file to be imputed */
...
m_time_arrive_usa m_total_der_fica_2009 m_total_der_fica_2010
;
