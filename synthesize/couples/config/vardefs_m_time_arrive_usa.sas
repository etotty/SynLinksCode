...
*** BASIC INFO;
%let variable=m_time_arrive_usa; /* name of sas variable on input file to be imputed */
...
%let universe_determinants=m_foreign_born; /* list of variables used to determine when &variable. is in universe */
...
f_nonwhite f_black f_hispanic f_foreign_born
...
m_sipp_birthdate m_total_der_fica_2009 m_total_der_fica_2010
;
