...
*** BASIC INFO;
%let variable=f_time_arrive_usa; /* name of sas variable on input file to be imputed */
...
%let universe_determinants=f_foreign_born; /* list of variables used to determine when &variable. is in universe */
...
f_sipp_birthdate f_total_der_fica_2009 f_total_der_fica_2010
