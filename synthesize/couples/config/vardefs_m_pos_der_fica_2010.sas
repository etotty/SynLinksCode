...
*** BASIC INFO;
%let variable=m_pos_der_fica_2010; /* name of sas variable on input file to be imputed */
...
%let universe_determinants=m_total_der_fica_2009; /* list of variables used to determine when &variable. is in universe */
