...
*** BASIC INFO;
%let variable=male; /* name of sas variable on input file to be imputed */
...
%let universe_determinants=hhh_flag; /* list of variables used to determine when &variable. is in universe */
...
%let stratifiers1=linked_couple linked_child hhh_flag;
%let stratifiers2=linked_couple linked_child;
